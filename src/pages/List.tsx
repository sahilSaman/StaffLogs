...
useEffect(()=>{
    ...
    useIonViewWillEnter(() => {
        ...
        // If you have any cleanup logic, you can return a function here.
        // For example, if you are subscribing to an event, you might unsubscribe here.
        return () => {
...
const clearList=()=>{
    showAlert({
        header:'Confirm',
        message:'Are you sure want to delete all users?',
        buttons:[
      ...
      <IonCard>
        <IonCardContent className='ion-no-padding'>
          <IonItem lines='none'>
            ...
            <IonLabel><IonSkeletonText animated style={{width:'150pd'}}/>
            <p><IonSkeletonText/></p>
            </IonLabel>
  ...
  <IonModal breakpoints={[0,0.5,0.8]} initialBreakpoint={0.5} ref={modal} isOpen={selectedUser!==null}
